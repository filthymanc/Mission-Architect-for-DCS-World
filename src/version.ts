...
export const APP_NAME = "Mission Architect for DCS World";

// Use the global constant injected by Vite, with a safe fallback.
// @ts-ignore: __APP_VERSION__ is defined in vite.config.ts
export const APP_VERSION = typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : "2.4.6-beta";
