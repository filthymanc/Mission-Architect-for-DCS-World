...
const ChatMessage: React.FC<ChatMessageProps> = ({ message }) => {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[85%] lg:max-w-[75%] rounded-2xl p-5 shadow-lg select-text transition-colors duration-300 ${isModel ? "bg-app-surface border border-app-border text-app-primary" : "bg-app-brand text-white rounded-br-sm"}`}
      >
