...
import { SUGGESTED_QUERIES } from "../../core/constants";
    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto py-8 animate-fadeIn select-none">
      ...
      >
        ...
        <div className="bg-app-surface border border-app-border p-4 rounded-xl flex items-center gap-4 shadow-sm transition-colors duration-300">
          ...
          <div>
            <h3 className="text-xs font-bold text-app-tertiary uppercase tracking-wider">
              Connection
            </h3>
            <p
              className={`font-mono font-bold text-sm ${getStatusTextColor()}`}
            >
        ...
        <div className="bg-app-surface border border-app-border p-4 rounded-xl flex items-center gap-4 shadow-sm transition-colors duration-300">
          <div
            className={`p-3 rounded-lg ${settings.isDesanitized ? "bg-red-900/20 text-red-500" : "bg-blue-900/20 text-blue-500"}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
          ...
          <div>
            ...
            <p
              className={`font-mono font-bold text-sm ${settings.isDesanitized ? "text-red-400" : "text-blue-400"}`}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h2 className="text-sm font-bold text-app-secondary uppercase tracking-wider ml-1">
            Quick Actions
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-bold text-app-primary group-hover:text-app-primary">
                  New Mission
                </span>
              </div>
          ...
          <h2 className="text-sm font-bold text-app-secondary uppercase tracking-wider ml-1 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2" role="list">
            {SUGGESTED_QUERIES.map((query, idx) => (
              ...
              >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 opacity-0 group-hover:opacity-100 transition-opacity transform -rotate-90"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
