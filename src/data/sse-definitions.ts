...
export const SSE_DEFINITIONS: Record<string, SSEDefinition[]> = {
    "Group": [
        {
            ...
            description: "Returns the Group object associated with the provided name string. Returns nil if not found.",
        ...
        {
            name: "Group.activate",
            description: "Activates a group that was set to 'Late Activation' in the Mission Editor.",
    ...
    "Unit": [
         {
            name: "Unit.getByName",
            description: "Returns the Unit object associated with the provided name string. Returns nil if not found.",
            signatures: ["Unit.getByName(name: string): Unit | nil"]
        },
        {
            name: "Unit.isActive",
            description: "Returns true if the unit is active (spawned and not destroyed).",
    ...
    "timer": [
        {
            ...
            description: "Schedules a function to run at a specific future time. Crucial for loops.",
            signatures: ["timer.scheduleFunction(functionToCall, functionArg, time: number): number"]
        },
        {
            name: "timer.getTime",
            description: "Returns the current mission time in seconds relative to mission start.",
            signatures: ["timer.getTime(): number"]
        },
        {
            name: "timer.getAbsTime",
            description: "Returns the absolute time in seconds (including day/month offsets).",
    ...
    "trigger": [
        {
            ...
            signatures: ["trigger.action.outText(text: string, delay: number, clearView?: boolean): void"]
        },
        {
        ...
        },
        {
            ...
            signatures: ["trigger.action.setUserFlag(flagName: string, value: number | boolean): void"]
        }
    ]
};