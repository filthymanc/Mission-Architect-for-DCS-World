    ...
    <div className="p-4 border-t border-app-border space-y-3 bg-app-frame">
      ...
      <div className="space-y-2 pb-2 border-b border-app-border">
         <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-app-tertiary uppercase tracking-wider">Interface Mode</span>
         </div>
         ...
         <div className="flex items-center justify-between pt-1">
            <span className="text-[10px] font-bold text-app-tertiary uppercase tracking-wider">Command Accent</span>
         </div>
            ...
            {accents.map(accent => (
                <button
                    ...
                    className={`w-5 h-5 rounded-full transition-transform border border-transparent ${
                        settings.themeAccent === accent.id ? 'scale-125 ring-2 ring-app-primary border-app-canvas' : 'hover:scale-110'
                    }`}
